...
- (void)setupMainView
{
    ...
    //特殊效果。加了一个底部遮罩
    UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, self.sd_height - IPhone_7_Scale_Width(36), self.sd_width ,IPhone_7_Scale_Width(36) )];
    imageView.image = [UIImage imageNamed:@"banner_bottom_bg"];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.delegate respondsToSelector:@selector(cycleScrollView:didSelectItemAtIndex:image:)]) {
        [self.delegate cycleScrollView:self didSelectItemAtIndex:[self pageControlIndexWithCurrentCellIndex:indexPath.item] image:cell.imageView.image];
    }
