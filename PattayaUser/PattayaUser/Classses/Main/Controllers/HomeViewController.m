...
-(void)netRequestData{
    ...
    NSLog(@"===%@",[PattAmapLocationManager singleton].presentLocation.address);
    ...
    [[PattayaUserServer singleton]  SeachStoreCodeRequest:nil success:^(NSURLSessionDataTask *operation, NSDictionary *ret) {
        ...
        _cardSwitch.items = model.content;
...
-(void)XLCardSwitchDidSelectedAt:(NSInteger)index{
    ...
    [self.navigationController pushViewController:[[ShopMainVC alloc]init] animated:YES];
}
