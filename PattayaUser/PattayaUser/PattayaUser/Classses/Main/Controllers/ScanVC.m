...
//  PattayaUser
//
//  Created by yanglei on 2018/10/11.
...
@interface ScanVC ()<AVCaptureMetadataOutputObjectsDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
- (void)drawImageForImageView:(UIImageView *)imageView
{
    ...
    //设置颜色
    CGContextSetStrokeColorWithColor(context, [App_Nav_BarDefalutColor CGColor]);
    //路径
...
- (void)drawLineForImageView:(UIImageView *)imageView
{
    ...
    //设置开始颜色
    const CGFloat *startColorComponents = CGColorGetComponents([App_Nav_BarDefalutColor CGColor]);
    //设置结束颜色
