...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/MoxieSDK-iOS/MoxieSDK/resources/mx_back@2x.png"
  install_resource "${PODS_ROOT}/MoxieSDK-iOS/MoxieSDK/resources/mx_quit@2x.png"
  install_resource "${PODS_ROOT}/MoxieSDK-iOS/MoxieSDK/resources/mx_refresh@2x.png"
  install_resource "${PODS_ROOT}/MoxieSDK-iOS/MoxieSDK/resources/mx_ScanningLine@2x.png"
